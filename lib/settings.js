...
exports.wallet = {
  ...
  "host": "localhost",
  // port: The port # that the wallet is configured to listen for RPC requests on. Configure this for Badcoin Core.
  "port": 0,
...
exports.shared_pages = {
  ...
  "page_footer": {
    ...
    "powered_by_text": "BadExplorer v{explorer_version}"
  }
};
...
exports.transaction_page = {
  ...
  //             For many bitcoin clones you can use the following cmd to find the list of transaction hashes from the genesis block: coin-cli getblock <genesis-block-hash>
...
exports.markets_page = {
  ...
  "exchanges": {
    ...
    "altmarkets": {
      ...
      //                Ex: "COIN/BTC", "COIN/USDT", "COIN/ETH"
      "trading_pairs": []
    },
...
exports.loadSettings = function loadSettings() {
  ...
  const settings_filename = '/etc/badexplorer/settings.json';
  let settings;
  let json_settings;
